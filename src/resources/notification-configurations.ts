...
export class NotificationConfigurations extends APIResource {
  ...
  ): Core.APIPromise<NotificationConfiguration> {
  ...
  retrieve(id: string, options?: Core.RequestOptions): Core.APIPromise<NotificationConfiguration>;
  retrieve(
    id: string,
  ...
  list(
    ...
    options?: Core.RequestOptions,
  ): Core.PagePromise<NotificationConfigurationsCursor, NotificationConfiguration>;
  list(
    options?: Core.RequestOptions,
  ): Core.PagePromise<NotificationConfigurationsCursor, NotificationConfiguration>;
  list(
  ...
  delete(id: string, options?: Core.RequestOptions): Core.APIPromise<NotificationConfiguration>;
  delete(
    id: string,
...
export class NotificationConfigurationsCursor extends Cursor<NotificationConfiguration> {}
...
NotificationConfigurations.NotificationConfigurationsCursor = NotificationConfigurationsCursor;
