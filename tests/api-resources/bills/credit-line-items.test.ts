...
describe('resource creditLineItems', () => {
  ...
  test('create: required and optional params', async () => {
    const response = await client.bills.creditLineItems.create('billId', {
      orgId: 'orgId',
      amount: 1,
      description: 'x',
      productId: 'productId',
  ...
  test('update: required and optional params', async () => {
    const response = await client.bills.creditLineItems.update('billId', 'id', {
      orgId: 'orgId',
      amount: 1,
      description: 'x',
      productId: 'productId',
  ...
  test('list: required and optional params', async () => {
    const response = await client.bills.creditLineItems.list('billId', {
      orgId: 'orgId',
      nextToken: 'nextToken',
      pageSize: 1,
    });
